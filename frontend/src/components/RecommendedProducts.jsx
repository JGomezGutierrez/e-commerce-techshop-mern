...
const RecommendedProducts = ({ category, title }) => {
                ...
                <button className='bg-gray-400 bg-opacity-50 shadow-md p-1 absolute right-0 text-lg hidden md:block' onClick={scrollbarRight}><FaAngleRight /></button>
                {
                    loading ? (
                        loadingList.map((_, index) => (
                            <div key={index} className='bg-white w-full min-w-[320px] md:min-w-[380px] max-w-[320px] md:max-w-[380px] rounded-sm shadow'>
                                <div className='bg-slate-300 h-48 p-4 min-w-[320px] md:min-w-[145px] flex justify-center items-center animate-pulse'></div>
                        ...
                        product.map((product, index) => (
                            <Link key={index} to={"producto/" + product?._id} className='bg-white w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] rounded-sm shadow'>
